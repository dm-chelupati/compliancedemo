...
To discover the workspace ID in the live deployment environment, resolve the subscription diagnostic setting first and then fetch the workspace customer ID:
