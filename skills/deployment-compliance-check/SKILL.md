...
| Container App | Running image | Caller evidence | Image labels | Tags | Verdict | Remediation |
|---|---|---|---|---|---|---|
| <name> | <image> | <caller / no event> | <valid / missing / unavailable> | <relevant values> | <verdict> | <candidate or blocked reason> |
```
